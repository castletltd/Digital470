...
void SystemInit_ExtMemCtl (void) {
 ...
 // }
  ...
  LPC_SCU->SFSCLK_0 = EMC_PIN_SET | 0;  /* CLK0                               */
	...
	/* moved from ram.c emcinit() */
	LPC_CCU1->CLK_M4_EMCDIV_CFG=(0x01<<5)|0x01;			/* set divide by 2 */
	LPC_CREG->CREG6|=1<16;													/* set divide by 2 */
	LPC_EMC->CONTROL = 0x01;
	LPC_EMC->CONFIG   = 0x00000000; 
	LPC_EMC->STATICCONFIG0 = 0x82;
...
/*  SysTick->CTRL &= ~(SysTick_CTRL_TICKINT_Msk | SysTick_CTRL_ENABLE_Msk);	*/
  ...
  /* Set vector table pointer */
	  SCB->VTOR = ((uint32_t) (&__Vectors)) & 0xFFF00000;
